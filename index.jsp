...
<head>
    <meta charset="utf-8">
    <title>Landing Page-Edufy</title>
...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0 px-lg-3">
            <a href="../index" class="navbar-brand ml-lg-3">
                <h1 class="m-0 text-primary">Edufy</h1>
            </a>
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-7">
                    ...
                    <p>Edufy is an educational website based in India. We are committed to 
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 my-5 pt-5 pb-lg-5">
                    ...
                    <p class="mb-4 pb-2">You should start learning with Edufy because we offer a diverse range of high-quality educational resources and experienced instructors to support your learning journey.</p>
                    <div class="d-flex mb-3">
                        ...
                        <div class="mt-n1">
                            ...
                            <p>The skilled instructors at Edufy are dedicated to providing high-quality education and mentorship to students.</p>
                        </div>
                    </div>
                    <div class="d-flex mb-3">
                        ...
                        <div class="mt-n1">
                            ...
                            <p>Edufy offers powerful and highly professional international certificates that are enriched with valuable skills.</p>
                        </div>
                    </div>
                    <div class="d-flex">
                        ...
                        <div class="mt-n1">
                            ...
                            <p class="m-0">Edufy provides online classes to accommodate flexible and accessible learning for students.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="main-text">
                            <h2>kaushal Reddy</h2>
                            <p>kaushal Reddy also takes on the role of a full-stack developer to help expedite the project's completion. 
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="main-text">
                            <h2>koushik</h2>
                            <p>koushik is the front-end developer and user interface (UI) designer. 
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="main-text">
                            <h2>Harish</h2>
                            <p>Harish is the back-end developer and database specialist. 
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mt-n1">
                                <h4>Email Us</h4>
                                <a href="https://mail.google.com//mail/?view=cm&fs=1&tf=1&to=kaushaljammula19@gmail.com" target="_blank"><p class="m-0">kaushaljammula19@gmail.com</p></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-content">
        ...
        <ul class="wrapper">
            ...
            <span><a href="https://wa.me/+918639421270" target="_blank"><i class="fab fa-whatsapp"></i></a></span>    
            </li>
        ...
        <div class="footer-bottom">
            <p>Copyright &copy; <a href="#">Edufy</a></p>
        </div>
    <!-- Footer End -->
